...
const obstacleImageRepository = require('../data_access_layer/obstacle/obstacle_image_repository')
...
container.register('obstacleImageRepository', awilix.asFunction(obstacleImageRepository))
